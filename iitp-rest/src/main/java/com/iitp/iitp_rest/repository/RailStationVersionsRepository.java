...
//    List<String> findFeaturesByVersionId(@Param("versionId") Long versionId);
    ...
    /** ⚠️ version_role 미지정 — DB에 uq_rail_station_version_role(version_id, version_role)
    ...
    Optional<RailStationVersion> findByVersionIdAndVersionRole(String versionId, BaseVersion.VersionRole versionRole);
