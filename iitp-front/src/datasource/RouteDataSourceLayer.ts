...
export default class RouteDataSourceLayer {
            ...
            for (const route of routes) {
                ...
                this.dataSource.entities.add(new Entity({
                    polyline: {
                        ...
                        width: 1.5,
                        material: new ColorMaterialProperty(Color.fromCssColorString('#00cc88')),
                        clampToGround: true,
                    },
                    properties: { OriginID: route.OriginID, DestinationID: route.DestinationID, featureType: "route" },
                }));
            }
        } finally {
