...
| 포장 노면표시(linkRef/laneRef/cellId) | Link는 유지한 채 numLane만 감소(필드 수정·그리드 Lane 행 삭제) | 사라진 레인/셀을 참조하는 노면표시가 정리되지 않고 그대로 남음 | ❌ 아직 안 고쳐진 갭 |
